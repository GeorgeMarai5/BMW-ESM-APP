...
export class ServiceNoteService {
  ...
  createServiceNote(Service_Note: Service_Note){
    return this.httpClient.post(this.apiUrl + '/api/ServiceNotes/Create' , Service_Note, this.httpOptions)
  ...
  getServiceNoteList(): Observable<Service_Note> {
    return this.httpClient
      .get<Service_Note>(this.apiUrl + '/api/ServiceNotes/GetAll')
      .pipe(
        retry(2),
  ...
  updateServiceNote(id, item): Observable<Service_Note> {
    return this.httpClient
      .put<Service_Note>(this.apiUrl + '/api/Fleets/' + id, item, this.httpOptions)
      .pipe(
        retry(2),
        catchError(this.handleError)
      )
